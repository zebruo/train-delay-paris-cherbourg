        ...
        blocs=[
            dict(
                ...
                pourquoi=(
                    ...
                    "rattrapé ensuite — mais seulement les circulations avec un retard "
                    "réellement connu et confirmées arrivées à leur terminus. La ponctualité "
                    "officielle évalue la performance au terminus ; le taux de « circulations "
                    "perturbées » reflète l'impact réel vécu tout au long de la ligne.\n\n"
                    "Le tooltip précise aussi « issues de X trains différents parmi les Y du "
                    "référentiel » — X peut dépasser Y sans que ce soit un problème actuel. Le "
                    "référentiel est reconstruit à partir d'un export SNCF limité à une fenêtre "
                    "glissante d'environ 151 jours : une variante d'horaire ancienne peut en "
                    "sortir au fil des régénérations et disparaître du référentiel, même si le "
                    "train a bien circulé et reste compté dans X. Pour savoir si le référentiel "
                    "est à jour maintenant, voir « Vérification GTFS » plus loin dans ce guide."
                ),
            ),
        ],
    ),
